...
class ChartManager:
    ...
    def _init_chart(self, epic):
        ...
        lines = {
            ...
            "ema_fast": ax.plot([], [], label="EMA Fast", color="darkgrey", linewidth=0.5, alpha=0.6)[0],
            "ema_slow": ax.plot([], [], label="EMA Slow", color="darkgrey", linestyle="--", linewidth=0.5, alpha=0.6)[0],
